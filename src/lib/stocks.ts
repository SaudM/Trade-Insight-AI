...
export const stocks: Stock[] = [
  ...
  { value: '600519.SS', label: '贵州茅台 (600519)' },
  { value: '601398.SS', label: '工商银行 (601398)' },
  { value: '600036.SS', label: '招商银行 (600036)' },
  { value: '601288.SS', label: '农业银行 (601288)' },
  { value: '601857.SS', label: '中国石油 (601857)' },
  { value: '600887.SS', label: '伊利股份 (600887)' },
  { value: '603288.SS', label: '海天味业 (603288)' },
  { value: '600276.SS', label: '恒瑞医药 (600276)' },
  { value: '601899.SS', label: '紫金矿业 (601899)' },
  { value: '000001.SZ', label: '平安银行 (000001)' },
  { value: '000002.SZ', label: '万科A (000002)' },
  { value: '000651.SZ', label: '格力电器 (000651)' },
  { value: '000858.SZ', label: '五粮液 (000858)' },
  { value: '002415.SZ', label: '海康威视 (002415)' },
  { value: '002594.SZ', label: '比亚迪 (002594)' },
  { value: '300750.SZ', label: '宁德时代 (300750)' },
  { value: '300059.SZ', label: '东方财富 (300059)' },
  { value: '300124.SZ', label: '汇川技术 (300124)' },
  { value: '300308.SZ', label: '中际旭创 (300308)' },
  { value: '300760.SZ', label: '迈瑞医疗 (300760)' },
  { value: '688012.SS', label: '中微公司 (688012)' },
  { value: '688981.SS', label: '中芯国际 (688981)' },
];
